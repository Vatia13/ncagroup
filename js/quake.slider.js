        ...
        quake: function (options) {
            ...
            return this.each(function () {
                ...
                function addNavigationControls() {
                    ...
                    nextLeft = ($('.quake-slider').width() / 2) + parseFloat($('.quake-nav-container').width() / 2);
                    $(".quake-next").css("left",nextLeft + "px");
                    prevLeft = ($('.quake-slider').width() / 2) - parseFloat($('.quake-nav-container').width() / 2) - 29;
                    $(".quake-prev").css("left",prevLeft + "px");
